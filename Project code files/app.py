...
#     # Simulated AI response (you can replace this with IBM Granite API)
#     ai_response = f"Simulated AI: I understood your question: '{user_message}'"
...
def ask_granite_model(prompt):
    ...
    system_prompt = (
        "You are Citizen AI, an intelligent assistant that helps Indian citizens with information about "
        "government services, civic issues, public documents, reporting problems, and general guidance. "
        "Respond politely and accurately based on Indian context."
    )
